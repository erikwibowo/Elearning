      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="http://localhost/elearning/dist/index">Stisla</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="http://localhost/elearning/dist/index_0">General Dashboard</a></li>
                <li class="active"><a class="nav-link" href="http://localhost/elearning/dist/index">Ecommerce Dashboard</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="http://localhost/elearning/dist/layout_default">Default Layout</a></li>
                <li><a class="nav-link" href="http://localhost/elearning/dist/layout_transparent">Transparent Sidebar</a></li>
                <li><a class="nav-link" href="http://localhost/elearning/dist/layout_top_navigation">Top Navigation</a></li>
              </ul>
            </li>
            <li class=""><a class="nav-link" href="http://localhost/elearning/dist/blank"><i class="far fa-square"></i> <span>Blank Page</span></a></li>
            <li class="dropdown ">
